...
# Replace DreamLights
dream_lights_replacement = """export function DreamLights({ active, phase }: { active: boolean; phase?: string }) {
...
content = re.sub(r"export function DreamLights\(.*?\n}\n", dream_lights_replacement + "\n", content, flags=re.DOTALL)
...
content = re.sub(r"export function CameraRig\(.*?\n}\n", camera_rig_replacement + "\n", content, flags=re.DOTALL)
...
content = re.sub(r"export function CandleSequence\(.*?\n}\n", candle_sequence_replacement + "\n", content, flags=re.DOTALL)
