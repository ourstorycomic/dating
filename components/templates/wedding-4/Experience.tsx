  ...
  return (
    ...
    >
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center px-6 text-center">
              ...
              <motion.div 
                ...
                className="relative w-48 h-32 bg-[#3a6186] rounded-md shadow-2xl mb-8 flex items-center justify-center border-t border-[#4b7b99]"
              >
                {/* Envelope flap */}
                <div className="absolute top-0 w-0 h-0 border-l-[96px] border-l-transparent border-r-[96px] border-r-transparent border-t-[60px] border-t-[#2d4b68]" />
                
                {/* Wax seal */}
                <motion.div 
                  animate={{ scale: [1, 1.1, 1] }} 
                  transition={{ repeat: Infinity, duration: 2 }}
                  className="absolute z-10 w-12 h-12 bg-[#e53935] rounded-full shadow-lg flex items-center justify-center border-2 border-[#b72825]"
                >
                  <span className="text-white text-xl">♥</span>
                </motion.div>
              </motion.div>

              <h1 className="text-4xl @sm:text-5xl font-normal text-[#3a6186] mb-2" style={{ fontFamily: "'Dancing Script', cursive" }}>{brideName}</h1>
              <span className="text-xl text-[#d4ba8a] font-light italic my-1" style={{ fontFamily: "'Dancing Script', cursive" }}>&amp;</span>
              <h1 className="text-4xl @sm:text-5xl font-normal text-[#3a6186] mt-2" style={{ fontFamily: "'Dancing Script', cursive" }}>{groomName}</h1>
      ...
      {!autoPlay && (
        <button 
          onClick={toggleAudio}
          className="fixed top-4 right-4 z-50 w-10 h-10 bg-white/80 backdrop-blur-md border border-[#3a6186]/20 rounded-full flex items-center justify-center shadow-[0_4px_15px_rgba(58,97,134,0.15)] transition-transform active:scale-95 pointer-events-auto"
        >
          {isPlaying ? (
             <svg className="w-4 h-4 text-[#3a6186] animate-spin-slow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3"></path></svg>
          ) : (
      ...
      <section className="relative w-full pb-16 flex flex-col items-center justify-start pt-16 bg-[#fdfbf7]">
        ...
        >
          ...
          <div className="flex items-center gap-4 text-[#3a6186] font-bold text-3xl @sm:text-4xl mt-2 tracking-wide">
            <span>{groomName}</span>
          ...
          <div className="flex items-center gap-3 text-xs uppercase tracking-widest text-[#455a64] mt-4">
            ...
            <span className="text-xl font-bold text-[#3a6186]">{dDay}</span>
      ...
      <section className="py-16 px-6 relative z-10 bg-[#fdfbf7] text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true, margin: "0px" }} className="max-w-xl mx-auto">
          ...
          <h2 className="text-[#3a6186] text-3xl @sm:text-4xl font-normal mb-8" style={{ fontFamily: "'Dancing Script', cursive" }}>Trân trọng kính mời</h2>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-2xl text-[#3a6186] font-bold mt-2 font-sans tracking-tight">{dTime}, {dDayOfWeek}</p>
            <div className="flex items-center justify-center gap-4 text-xl text-[#455a64] mt-2 border-y border-[#d4ba8a]/50 py-3 w-full">
              ...
              <span className="text-4xl text-[#3a6186] font-bold mx-2">{dDay}</span>
      ...
      <section className="py-12 px-4 bg-[#fdfbf7] border-b border-[#d4ba8a]/20">
        <div className="max-w-md mx-auto text-center">
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-12">
            <p className="text-[#3a6186] text-xl font-bold uppercase tracking-widest mb-2 font-sans">Tiệc Đám Cưới</p>
            ...
            <div className="flex justify-between items-start px-4 relative">
              ...
              {[
                ...
                <div key={idx} className="flex flex-col items-center relative z-10 w-1/3">
                  <div className="w-10 h-10 rounded-full bg-white border border-[#3a6186] text-[#3a6186] flex items-center justify-center mb-3 shadow-md">
                    {item.icon}
                  </div>
                  <p className="text-[#3a6186] font-bold font-sans text-sm">{item.time}</p>
      ...
      <section className="relative pt-12 pb-24 bg-[#fdfbf7] flex flex-col items-center overflow-hidden">
        ...
        <div className="flex justify-between items-end w-full max-w-md px-12 -mt-6 relative z-30">
          <div className="text-center">
            ...
            <p className="text-[#3a6186] font-bold text-lg font-sans">{groomName}</p>
          </div>
          <div className="text-center">
            <p className="text-[10px] uppercase text-[#d4ba8a] font-bold tracking-widest mb-1">Bride</p>
            <p className="text-[#3a6186] font-bold text-lg font-sans">{brideName}</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white relative">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
          <h2 className="text-4xl text-[#3a6186] flex items-center justify-center gap-2" style={{ fontFamily: "'Dancing Script', cursive" }}>
        ...
        <div className="max-w-md mx-auto grid grid-cols-2 gap-3 px-2">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="col-span-1 aspect-square bg-[#fdfbf7] rounded-xl border border-gray-100 shadow-sm flex flex-col items-center justify-center p-2 relative">
             <p className="text-[#3a6186] font-bold font-sans text-xs uppercase mb-2">{dMonth}</p>
      ...
      <section className="py-20 px-4 bg-[#fdfbf7] flex justify-center border-t border-[#d4ba8a]/20 relative">
        ...
        >
          <div className="text-center mb-8">
            <p className="text-[10px] text-[#3a6186] font-sans uppercase tracking-[0.2em] font-bold">Hy vọng bạn sẽ đến</p>
            <h2 className="text-[#3a6186] text-4xl mt-1" style={{ fontFamily: "'Dancing Script', cursive" }}>R.S.V.P</h2>
          </div>
          ...
          {!rsvpSubmitted ? (
            <form onSubmit={handleRSVP} className="space-y-4 font-sans relative z-10">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:border-[#3a6186] focus:ring-1 focus:ring-[#3a6186] focus:outline-none text-sm transition-all text-[#3a6186] shadow-sm" 
              ...
              <div className="mt-6 text-center bg-gray-50 p-4 rounded-lg border border-gray-200">
                <label className="block text-[10px] font-bold text-[#3a6186] uppercase tracking-widest mb-3">Số lượng người tham dự</label>
            ...
            <div className="text-center py-10">
              ...
              <h3 className="text-lg font-bold text-[#3a6186] uppercase tracking-widest mt-2">Đã nhận phản hồi</h3>
      ...
      <section className="relative h-[500px] flex flex-col items-center justify-center overflow-hidden bg-white">
        ...
        <motion.div 
          ...
          className="relative z-10 text-center text-[#3a6186] p-8 mt-40"
        >
