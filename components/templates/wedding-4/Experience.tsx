          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.8 }} className="text-center mb-16 w-full">
            ...
            <div className="flex justify-between items-start w-full px-1 mb-8">
              <div className="text-center w-[46%]">
                ...
                <p className="text-xl sm:text-2xl text-[#2D2A28] whitespace-pre-line leading-relaxed" style={{ fontFamily: 'var(--font-dancing)' }}>{groomFamily}</p>
              </div>
              ...
              <div className="text-center w-[46%]">
                ...
                <p className="text-xl sm:text-2xl text-[#2D2A28] whitespace-pre-line leading-relaxed" style={{ fontFamily: 'var(--font-dancing)' }}>{brideFamily}</p>
              </div>
            </div>
