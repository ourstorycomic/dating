...
const packages = [
  {
    ...
    features: ["Làm thường (2-3 ngày): 99.000đ", "Làm gấp (<24h): 149.000đ", "Có nhạc nền", "Form xác nhận tham dự"],
    featured: false,
    color: "#2D2A28",
  },
  {
    ...
    features: ["Làm thường (2-3 ngày): 169.000đ", "Làm gấp (<24h): 239.000đ", "Chỉnh sửa nội dung cơ bản", "Đầy đủ nhạc & Form xác nhận"],
    featured: true,
    color: "#C5A880",
  },
  {
    ...
    features: ["Chung mẫu: 199.000đ (Gấp: 279.000đ)", "Khác mẫu: 229.000đ (Gấp: 319.000đ)", "Chỉnh sửa nội dung cơ bản", "Đầy đủ nhạc & Form xác nhận"],
    featured: false,
    color: "#2D2A28",
  },
];
